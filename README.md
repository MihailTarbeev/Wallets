...
|-------|----------|----------|
| `GET` | `/api/v1/drf-auth/login/` | Авторизация на основе сессии |
| `GET` | `/api/v1/auth/users/` | Получение списка всех пользователей |
| `POST` | `/api/v1/auth/users/` | Создание нового пользователя |
| `POST` | `/auth/token/login/` | Авторизация на основе токена |
| `POST` | `/auth/token/logout/` | Выход из системы на основе токена |
| `POST` | `/api/v1/token/` | Авторизация на основе JWT-токена |
| `POST` | `api/v1/token/refresh/` | Получение нового access JWT-токена по refresh-токену |
