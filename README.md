...
- [⚙️ Скрипт entrypoint.sh](#section-entrypointsh)
- [👨‍💻 Автор](#section-avtor)
...
<a id="section-entrypointsh"></a>
## ⚙️ Скрипт entrypoint.sh

Скрипт entrypoint.sh автоматизирует инициализацию приложения:
1. Ожидание готовности PostgreSQL (30 попыток)
2. Применение миграций Django
3. Загрузка тестовых данных из db.json (только при первом запуске)
4. Запуск Django сервера

Основные функции:
- Автоматическое применение миграций
- Загрузка данных только при пустой БД
